...
class Stack
{
   ...
   void Reverse(Stack S)
   {
      ...
      while (S.Isempty()!= true)
       S1.Push(S.Pop());
               //Pop elements from orignal stack S until it becomes empty and Push those elements into additional stack S1
      
      S=S1;   //Assigning elements of additional stack S1 to original stack S
